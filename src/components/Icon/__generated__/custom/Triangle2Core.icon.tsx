...
/**
 * React component generated from custom icon: `triangle2-core`.
 * Auto-generated before NPM release
 *
 * @params {CommonIconProps} [props = commonIconDefaulProps] - the icon's size and color
 * @returns {JSX.Element} - the icon
 */
export const Triangle2Core = (props: CommonIconProps): JSX.Element => {
  ...
  return (
    ...
    >
      <path
        d="M8.27988 11.1401L12.7314 3.62806C12.8549 3.41975 12.7047 3.15625 12.4626 3.15625L3.55947 3.15625C3.31733 3.15625 3.16719 3.41975 3.29063 3.62806L7.7422 11.1401C7.86324 11.3443 8.15884 11.3443 8.27988 11.1401Z"
        fill={color}
      />
      <path
        fillRule="evenodd"
