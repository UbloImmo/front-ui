...
/**
 * React component generated from custom icon: `squircle-arrow-bottom-fill`.
 * Auto-generated before NPM release
 *
 * @params {CommonIconProps} [props = commonIconDefaulProps] - the icon's size and color
 * @returns {JSX.Element} - the icon
 */
const SquircleArrowBottomFill = (props: CommonIconProps): JSX.Element => {
...
export default SquircleArrowBottomFill;
