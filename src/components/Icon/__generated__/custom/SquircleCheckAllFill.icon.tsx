...
/**
 * React component generated from custom icon: `squircle-check-all-fill`.
 * Auto-generated before NPM release
 *
 * @params {CommonIconProps} [props = commonIconDefaulProps] - the icon's size and color
 * @returns {JSX.Element} - the icon
 */
const SquircleCheckAllFill = (props: CommonIconProps): JSX.Element => {
...
export default SquircleCheckAllFill;
