...
/**
 * React component generated from custom icon: `convexe-core`.
 * Auto-generated before NPM release
 *
 * @params {CommonIconProps} [props = commonIconDefaulProps] - the icon's size and color
 * @returns {JSX.Element} - the icon
 */
const ConvexeCore = (props: CommonIconProps): JSX.Element => {
  ...
  return (
    ...
    >
      <path
        d="M3.51585 3.51928C3.16103 5.27669 3.00165 6.63559 3.00001 7.95726C2.99837 9.2864 3.1562 10.6736 3.51928 12.4842C5.27669 12.839 6.63559 12.9984 7.95726 13C9.2864 13.0016 10.6736 12.8438 12.4842 12.4807C12.839 10.7233 12.9984 9.36441 13 8.04274C13.0016 6.7136 12.8438 5.32644 12.4807 3.51585C10.7233 3.16104 9.36441 3.00165 8.04274 3.00001C6.7136 2.99837 5.32644 3.15619 3.51585 3.51928Z"
        fill={color}
      />
      <path
        fillRule="evenodd"
