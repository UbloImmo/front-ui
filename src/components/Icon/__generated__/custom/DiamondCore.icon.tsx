...
/**
 * React component generated from custom icon: `diamond-core`.
 * Auto-generated before NPM release
 *
 * @params {CommonIconProps} [props = commonIconDefaulProps] - the icon's size and color
 * @returns {JSX.Element} - the icon
 */
const DiamondCore = (props: CommonIconProps): JSX.Element => {
  ...
  return (
    ...
    >
      <path
        d="M7.64648 3.35357C7.84173 3.15837 8.15825 3.15836 8.3535 3.35357L12.6464 7.64648C12.8416 7.84172 12.8416 8.15825 12.6464 8.3535L8.3535 12.6464C8.15825 12.8416 7.84173 12.8416 7.64648 12.6464L3.35357 8.3535C3.15836 8.15825 3.15836 7.84173 3.35357 7.64648L7.64648 3.35357Z"
        fill={color}
      />
      <path
        fillRule="evenodd"
