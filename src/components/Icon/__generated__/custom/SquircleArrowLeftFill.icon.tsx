...
/**
 * React component generated from custom icon: `squircle-arrow-left-fill`.
 * Auto-generated before NPM release
 *
 * @params {CommonIconProps} [props = commonIconDefaulProps] - the icon's size and color
 * @returns {JSX.Element} - the icon
 */
const SquircleArrowLeftFill = (props: CommonIconProps): JSX.Element => {
...
export default SquircleArrowLeftFill;
