...
/**
 * React component generated from custom icon: `triangle2-core-2nd-half`.
 * Auto-generated before NPM release
 *
 * @params {CommonIconProps} [props = commonIconDefaulProps] - the icon's size and color
 * @returns {JSX.Element} - the icon
 */
export const Triangle2Core2NdHalf = (props: CommonIconProps): JSX.Element => {
  ...
  return (
    ...
    >
      <path
        d="M12.4626 3.15625L8.01099 3.15625L8.01099 11.2933C8.11515 11.2933 8.21931 11.2422 8.27983 11.1401L12.7314 3.62807C12.8548 3.41975 12.7047 3.15625 12.4626 3.15625Z"
        fill={color}
      />
      <path
        fillRule="evenodd"
