...
/**
 * React component generated from custom icon: `circle-core-half`.
 * Auto-generated before NPM release
 *
 * @params {CommonIconProps} [props = commonIconDefaulProps] - the icon's size and color
 * @returns {JSX.Element} - the icon
 */
const CircleCoreHalf = (props: CommonIconProps): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M8 13C5.23858 13 3 10.7614 3 8C3 5.23858 5.23858 3 8 3V13Z"
        fill={color}
      />
    </svg>
  );
