...
/**
 * React component generated from custom icon: `circle-core-2nd-half`.
 * Auto-generated before NPM release
 *
 * @params {CommonIconProps} [props = commonIconDefaulProps] - the icon's size and color
 * @returns {JSX.Element} - the icon
 */
const CircleCore2NdHalf = (props: CommonIconProps): JSX.Element => {
...
export default CircleCore2NdHalf;
